                    ...
                    <form class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="book_name">Tên tác giả</label>
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="book_price">Địa chỉ</label>
                                <div class="col-md-4">
                           ...
                           <!-- Textarea -->
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="book_description">Tiểu sử</label>
                              <div class="col-md-4">                     
                                <textarea class="form-control" id="book_description" name="book_description">tiểu sử tác giả</textarea>
                              </div>
                            </div>
