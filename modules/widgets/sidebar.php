    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav clearfix" id="side-menu">
            <li style="padding: 70px 0 0;">
                <a href="#" class="waves-effect"><i class="fa fa-dashboard fa-fw" aria-hidden="true"></i>Dashboard</a>
            </li>
            <li>
                <a href="<?php createPath('admin'); ?>" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Admin</a>
            </li>
            <li>
                <a href="<?php createPath('books'); ?>" class="waves-effect"><i class="fa fa-book fa-fw" aria-hidden="true"></i>Sách</a>
            </li>
            <li>
                <a href="<?php createPath('orders'); ?>" class="waves-effect"><i class="fa fa-shopping-basket fa-fw" aria-hidden="true"></i>Đơn hàng</a>
            </li>
            <li>
